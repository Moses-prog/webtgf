...
if main_menu_old in c:
    ...
    print("WARNING: Could not find main_menu")
...
if idx_drip != -1:
    ...
    print("WARNING: Could not find menu_drip_posting")
...
def replace_back(marker, new_back):
    ...
    for i, line in enumerate(lines):
        ...
        if in_block and ('b"back"' in line or 'b\\'back\\'' in line) and 'Button.inline' in line:
            ...
            in_block = False # Only replace once per block
    c = '\\n'.join(lines)
