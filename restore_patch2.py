...
main_menu_old = '''        else:
            buttons.extend([
                ...
                [Button.inline("🕐 Drip Posting", b"menu_drip_posting")],
...
if main_menu_old in c:
    c = c.replace(main_menu_old, main_menu_new)
...
if idx_drip != -1:
    c = c[:idx_drip] + submenus_and_sleep + '\\n' + c[idx_drip:]
...
def replace_back_safe(marker, new_back):
    global c
    lines = c.split('\\n')
    in_block = False
...
replace_back_safe('elif data == "menu_image":', 'back_modifications')
replace_back_safe('elif data == "menu_words":', 'back_modifications')
replace_back_safe('elif data == "menu_links":', 'back_modifications')
replace_back_safe('elif data == "menu_drip_posting":', 'back_autoposting')
